...
#def welcome_view(request):
     #message = f"<html><h1>Wlecome to Bookr!</h1><p>{Book.objects.count()} and counting!</p</html>"
     #return render(request, 'base.html')
...
def book_media(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            book.save()
            messages.success(request, "Book \"{}\" was succesfully updated.".format(book))
    ...
    return render(request, "reviews/instance-form.html", {"instance": book, "form": form,
...
def react_example(request):
    ...
    return render(request, "react-example2.html", {"name": "Ben", "target": 5})
